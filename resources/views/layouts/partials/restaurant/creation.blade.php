...
<form action="{{ route('admin.restaurants.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="my-2">
        ...
        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name"
            value="{{ old('name') }}" placeholder="es.Locanda Team 6" required>
    ...
    <div class="my-2">
        ...
        <input type="text" class="form-control @error('address') is-invalid @enderror" id="address" name="address"
            value="{{ old('address') }}" placeholder="es.Via Italia n* 6" required>
    ...
    <div class="my-2">
        ...
        <input type="text" class="form-control @error('contact_email') is-invalid @enderror" id="contact_email"
            name="contact_email" value="{{ old('contact_email') }}" placeholder="es.example@gmail.com" required>
    ...
    <div class="my-2">
        ...
        @error('typeList')
            <div class="alert alert-danger">{{ $message }}</div>
        @enderror
        <small id="name" class="form-text text-muted">Select your Restaurant's Types</small>
    </div>

    <div class="my-2">
        <label for="vat" class="form-label">Vat</label>
        <input type="text" class="form-control @error('vat') is-invalid @enderror" id="vat" name="vat"
            value="{{ old('vat') }}" placeholder="es.11111111111" required>
