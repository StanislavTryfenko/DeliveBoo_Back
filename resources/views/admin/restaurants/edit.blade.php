<!-- 
    ...
    @section('content')
        <div class="container-fluid p-4">
            ...
            <h3 class="pb-3">Modifica le informazioni del tuo ristorante</h3>
            ...
            <form name="restaurantForm" onsubmit="return validateRestaurantForm()"
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-3">
                        <label for="phone_number" class="form-label"><strong>Numero Telefonico</strong></label>
                    ...
                    <div class="col-3">
                        <label for="contact_email" class="form-label"><strong>Email</strong></label>
                    ...
                    <div class="col">
                        @if ($restaurant->thumb)
                            <img width="140" src="{{ asset('storage/' . $restaurant->thumb) }}"
                                alt="{{ $restaurant->name }}">
                        @endif
                        <label for="thumb" class="form-label"><strong>Immagine di Copertina</strong></label>
                ...
                <div class="mb-2">
                    @if ($errors->any())
                        <label for="type" class="form-label"><strong>Categoria Ristorante</strong></label>
                ...
                <div class="mb-2">
                    <label for="vat" class="form-label"><strong>Vat</strong></label>
